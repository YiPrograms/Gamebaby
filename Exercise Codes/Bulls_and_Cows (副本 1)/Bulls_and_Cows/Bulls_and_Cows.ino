...
struct GameData {
    char R[6];       // the four correct numbers
    char guess[6];   // the four numbers that player provides
...
void generate() {
    if(gameState == testingMode) {
        ...
        for (int i=0; i<5; i++) gameData.R[i]=a[i]+'0', gameData.histR[a[i]]=true;
